...
//    @Environment(\.dismiss) private var dismiss
//    
//    init(authViewModel: AuthViewModel, startDate: Binding<Date?>, endDate: Binding<Date?>) {
//        self.authViewModel = authViewModel
//        self._viewModel = StateObject(wrappedValue: BookingViewModel(authViewModel: authViewModel))
