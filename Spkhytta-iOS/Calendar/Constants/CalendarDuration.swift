...
struct CalendarConstants {
   ...
   static let currentMonth: Int = Calendar.current.component(.month, from: Date())
    ...
    // Om vi vill ha år te nå, og extra år plus +9 = 10år i kalendern. Om vi vil ha flere månter kan vi legge til +11 och då får vi ett år. Hjelp fra Mohammad Data ingenjør
