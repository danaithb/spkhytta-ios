...
////
////det här api:et är inte nog säkert att använda. så vi bör köra ett traditionellet från backend.
//
//import Foundation
//
...
////om inte den ska va på servern så måste jag iaf ha domännamn
////bara
//
//
